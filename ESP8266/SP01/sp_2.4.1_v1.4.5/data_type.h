...
typedef struct {
  float  F = 0;                                                         // Frequency * 100
  float PF = 0;                                                         // Power Factor * 100
  float V = 0;                                                          // Voltage * 100
  float A = 0;                                                          // Ampere * 100
}S_Meas;

typedef struct {
  float WATT  = 0;                                                      // Active Power
  float VAR   = 0;                                                      // Reactive Power
}S_Power;
...
typedef struct { 
  ...
  S_Meas Measure;                                                       // Measurment
  S_Power Power;                                                        // Power
  float Energy;                                                         // Energy
}S_MyData;

typedef struct { 
  float H[24];                                                     // Hour Energy
  float D[31];                                                     // Day Energy
  float M[12];                                                     // Month Energy
}S_Monitor;
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
